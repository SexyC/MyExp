...
int LowestIDCluster::getNearestNodeToPos(const Coord& pos) {
	...
	hdcEV << "getNearestNodeToPos: " << minDistNodeId << endl;

	return minDistNodeId;
}

int LowestIDCluster::getNearestNodeToPos(const unordered_map<int, unordered_map<int, int> >& neighbors,
			const Coord& pos) {
...
int LowestIDCluster::getNextHopId(int dstId) {
...
int LowestIDCluster::headGateWayGetNextHopId(int dstId) {
...
int LowestIDCluster::headGetNextHopId(int dstId) {
...
int LowestIDCluster::gateWayGetNextHopId(int dstId) {
...
int LowestIDCluster::memberGetNextHopId(int dstId) {
